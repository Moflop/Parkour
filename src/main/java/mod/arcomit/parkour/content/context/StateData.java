...
public class StateData {
	...
	public static final StreamCodec<ByteBuf, StateData> STREAM_CODEC =
			StreamCodec.composite(ResourceLocation.STREAM_CODEC, StateData::getStateId,
	...
	private transient ResourceLocation cachedKey = ParkourStates.DEFAULT.getId();
	 ...
	 */
	public StateData(ResourceLocation stateId, int ticksInState, int animVariant) {
