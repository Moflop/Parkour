...
public class Directions {
	...
	/**
	 * 从候选方向列表中选出相邻方块中心离玩家水平位置最近的一个。
	 * 仅在 XZ 平面计算距离，忽略 Y 轴差异。列表为空时返回 null。
	 *
	...
	/**
	 * 判断玩家水平朝向与目标方向之间的偏角是否在允许范围内。
	 * 比较时仅考虑 Yaw（水平旋转），自动处理 360 度环绕差值。
	 *
	 * @param player   目标玩家，不可为null
	 * @param dir      目标方向
	 ...
	 */
	public static boolean isFacing(Player player, Direction dir,
			float maxAngle) {
