...
public class ClientAnimationRegistry {
	...
	private static final Map<ResourceLocation, IntFunction<PlayerAnimation>> STATE_ANIMATIONS =
			new HashMap<>();
	private static final Map<ResourceLocation, IModifierFactory> MODIFIER_FACTORIES =
			new HashMap<>();
	private static final Map<ResourceLocation, Function<AbstractClientPlayer, AbstractModifier>>
	 ...
	 */
	public static void registerStateAnimation(ResourceLocation stateId,
	 ...
	 */
	public static void registerModifierFactory(ResourceLocation stateId,
	 ...
	 */
	public static void registerActionModifier(ResourceLocation actionId,
	 ...
	 */
	public static AbstractModifier getActionModifier(ResourceLocation actionId,
